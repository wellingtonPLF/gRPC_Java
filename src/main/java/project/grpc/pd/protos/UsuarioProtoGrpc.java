...
public final class UsuarioProtoGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<project.grpc.pd.protos.UserIdRequest,
      project.grpc.pd.protos.UserResponse> getUsuarioPorIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "usuarioPorId",
      requestType = project.grpc.pd.protos.UserIdRequest.class,
      responseType = project.grpc.pd.protos.UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<project.grpc.pd.protos.UserIdRequest,
      project.grpc.pd.protos.UserResponse> getUsuarioPorIdMethod() {
    io.grpc.MethodDescriptor<project.grpc.pd.protos.UserIdRequest, project.grpc.pd.protos.UserResponse> getUsuarioPorIdMethod;
      ...
      synchronized (UsuarioProtoGrpc.class) {
        if ((getUsuarioPorIdMethod = UsuarioProtoGrpc.getUsuarioPorIdMethod) == null) {
          UsuarioProtoGrpc.getUsuarioPorIdMethod = getUsuarioPorIdMethod = 
              io.grpc.MethodDescriptor.<project.grpc.pd.protos.UserIdRequest, project.grpc.pd.protos.UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "usuarioProto.UsuarioProto", "usuarioPorId"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  project.grpc.pd.protos.UserIdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  project.grpc.pd.protos.UserResponse.getDefaultInstance()))
  ...
  public static abstract class UsuarioProtoImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void usuarioPorId(project.grpc.pd.protos.UserIdRequest request,
        io.grpc.stub.StreamObserver<project.grpc.pd.protos.UserResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                project.grpc.pd.protos.UserIdRequest,
                project.grpc.pd.protos.UserResponse>(
  ...
  public static final class UsuarioProtoBlockingStub extends io.grpc.stub.AbstractStub<UsuarioProtoBlockingStub> {
    ...
    /**
     */
    public project.grpc.pd.protos.UserResponse usuarioPorId(project.grpc.pd.protos.UserIdRequest request) {
  ...
  public static final class UsuarioProtoFutureStub extends io.grpc.stub.AbstractStub<UsuarioProtoFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<project.grpc.pd.protos.UserResponse> usuarioPorId(
        project.grpc.pd.protos.UserIdRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_USUARIO_POR_ID:
          serviceImpl.usuarioPorId((project.grpc.pd.protos.UserIdRequest) request,
              (io.grpc.stub.StreamObserver<project.grpc.pd.protos.UserResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UsuarioProtoBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return project.grpc.pd.protos.userProtos.getDescriptor();
    }
